        ...
        <div class="container-fluid my-5">
            <div class="row">               
                <div class="col-md-12">
                    ...
                    <?php if(\App\Classes\Session::has('product_delete')): ?>
                        <?php echo e(\App\Classes\Session::flash('product_delete')); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php $__currentLoopData = $sub_cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($sub_cat->id == $product->sub_cat): ?>
                            ...
                            <td>
                                <img src="<?php echo e($product->image); ?>" alt="" with="100" height="80">
                            </td>
                            <td><?php echo e($product->description); ?></td>
                        <td><a href="#" class="text-success mr-2" onclick="showEditProductModal('<?php echo e($product->name); ?>','<?php echo e($product->price); ?>','<?php echo e($product->sub_cat); ?>','<?php echo e($product->image); ?>','<?php echo e($product->description); ?>')"><i class="fa fa-edit"></i></a>
                            <a href="<?php echo e(url('/admin/product/delete/'.$product->id)); ?>" class="text-danger mr-2"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>                       
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                            ...
                            <div class="modal-content py-2 px-3">
                                ...
                                <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="proCreate">
                                        ...
                                        <input type="hidden" id="pro_token" name="pro_token" value="<?php echo e(App\Classes\CSRFToken::_token()); ?>">                       
                            ...
                            <div class="modal-content py-2 px-3">
                                ...
                                <div class="modal-body">
                                    <form action="" method="POST" enctype="multipart/form-data" id="proCreate">
                                        ...
                                        <input type="hidden" id="pro_edit_token" name="pro_token" value="<?php echo e(App\Classes\CSRFToken::_token()); ?>">                       
                                            <div class="row justify-content-end no-gutters">
                                                <button type="button" class="btn btn-outline-secondary mr-2" data-dismiss="modal">Cancel</button>
