                ...
                <table class="table table-bordered">
                    ...
                    <tr class="d-none" id="paymentBtn">
                        <td colspan="7" class="text-right">
                            <form action="<?php echo e(url('/payment/stripe')); ?>" method="post">
                                <script src="https://checkout.stripe.com/checkout.js" class="stripe-button"
                                    data-key="<?php echo e(App\Classes\Session::get('publishable_key')); ?>"
                                    data-name="MyShop"
                                    data-description="We are the Best"
                                    data-amount="<?php echo e(App\Classes\Session::get('total_amount') * 100); ?>"
                                    data-email="<?php echo e(App\Classes\Auth::user("user_name")); ?>@gmail.com"
                                    data-locale="auto">
                                </script>
                            </form>
                        </td>
